...
const MainPage = () => {
  ...
  return (
    <div className="bg-[#121212] min-h-screen text-white">
      ...
      <section
        className="bg-cover py-64 px-8 flex justify-end"
        style={{ backgroundImage: `url(${bgImage})` }}
      >
        <div className="flex flex-col">
          <div className="mb-8 max-w-xl mx-auto">
            <p className="text-4xl font-bold text-white leading-snug text-start drop-shadow-lg">
          ...
          <div className="p-8 bg-opacity-60 bg-[#525252] rounded-lg max-w-xl mx-auto">
            ...
            <p className="text-lg">
              No dudes en adquirir el auto de tus sueños. Para cotizarlo,
              ingresa tus datos:
            </p>
            <form onSubmit={sendRequest} className="max-w-xl mx-auto">
              <div className="grid grid-cols-1 sm:grid-cols-2 py-8 gap-6">
                ...
                >
                  <option
                    className="bg-[#525252] bg-opacity-0 text-black"
                    value=""
                  >
              ...
              <button
                type="submit"
                className="w-full bg-[#121212] text-white font-semibold px-6 py-2 rounded-lg shadow-md hover:bg-gray-100 hover:text-black transition duration-300 mt-4"
              >
